...
export type ListActivitiesCallback = (success: boolean, data: Activity[] | SQLError) => void;

// For adding an activity where you would probably return the inserted activity's ID on success
export type AddActivityCallback = (success: boolean, data: {insertId: number} | SQLError) => void;
export { SQLError };
